...
try:
    ...
    tcp_socket.send_scpi_command(f'SOUR1:CURR:BIAS {spikesafe_python.Precision.get_precise_current_command_argument(0.01)}')   
    ...
    spikesafe_python.ReadAllEvents.read_until_event(tcp_socket, spikesafe_python.SpikeSafeEvents.PULSED_SWEEP_COMPLETE) # event 109 is "Pulsed Sweep Complete"
