# Goal: Connect to a SpikeSafe and run Pulsed mode into a shorting plug. Take voltage measurements from the pulsed output using the SpikeSafe SMU's integrated Digitizer
...
try:
    ...
    # set Digitizer trigger source to hardware. When set to a hardware trigger delay, the digitizer waits for a trigger signal from the SpikeSafe to start a measurement
    ...
    digitizerData = tcp_socket.read_data_until_end()
