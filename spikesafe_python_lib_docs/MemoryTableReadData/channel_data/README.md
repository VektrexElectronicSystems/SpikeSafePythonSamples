# [spikesafe-python API Overview](/spikesafe_python_lib_docs/README.md) | [MemoryTableReadData](/spikesafe_python_lib_docs/MemoryTableReadData/README.md) | channel_data
...
### Attribute Value
[ChannelData](/spikesafe_python_lib_docs/ChannelData/README.md)  

### Examples
The following example demonstrates the channel_data attribute. It initiates the request for SpikeSafe Memory Table Read and extracts bulk voltage, Channel 1's data, and Heat Sink 1's Temperature data from a MemoryTableReadData object.
```
