...
| INVALID_APERTURE | 401 |
| INVALID_READ_COUNT | 402 |
| INVALID_TRIGGER_COUNT | 403 |
| INVALID_TRIGGER_DELAY | 404 |
| INVALID_TRIGGER_SOURCE | 405 |
| INVALID_TRIGGER_EDGE | 406 |
| INVALID_RANGE | 407 |
| INVALID_RUN_SETTING | 409 |
| MISSING_APERTURE_PARAMETER | 410 |
| MISSING_RANGE_PARAMETER | 411 |
| MISSING_TRIGGER_COUNT_PARAMETER | 412 |
| MISSING_TRIGGER_DELAY_PARAMETER | 413 |
| MISSING_TRIGGER_EDGE_PARAMETER | 414 |
| MISSING_TRIGGER_SOURCE_PARAMETER | 415 |
| MISSING_READ_COUNT_PARAMETER | 416 |
| OVER_RANGE_TRIPPED | 418 |
| INVALID_STATE | 419 |
| RECEIVE_BUFFER_OVERFLOW | 420 |
| INVALID_OUTPUT_TRIGGER_EDGE | 421 |
| INVALID_TRIGGER_SOURCE_422 | 422 |
| INVALID_SAMPLING_MODE_SETTING | 423 |
| MISSING_SAMPLING_MODE_PARAMETER | 424 |
| MISSING_ENABLING_RAW_DATA_PARAMETER | 425 |
| INVALID_ENABLING_RAW_DATA_SETTING | 426 |
| RAW_DATA_NOT_ENABLED | 427 |
| ENABLING_RAW_DATA_REQUIRES_MEASUREMENT_SEQUENCE_TO_BE_IDLE | 428 |
| INVALID_OUTPUT_TRIGGER_DELAY | 429 |
| MISSING_OUTPUT_TRIGGER_DELAY_PARAMETER | 430 |
